    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.SetTwoFactorSuccess ? "Uwierzytelnianie dwu etapowe zostało ustalone."
                ...
                : message == ManageMessageId.PhotoUploadSuccess ? "Zdjęcie zostało zapisane pomyślnie"
                : message == ManageMessageId.FileExtensionError ? "Dozwolone są tylko zdjęcia z rozszerzeniem jpg, png, gif."
                : message == ManageMessageId.ExceededFileSize ? "Rozmiar pliku jest za duzy, maksymalny rozmiar to " + ConfigurationManager.AppSettings["MaxFileSize"] + " bajtów."
                : "";
        ...
        public async Task<ActionResult> UploadPhoto(HttpPostedFileBase file, string userName = "")
        {
            if (file != null && file.ContentLength > 0)
            {
                ...
                {
                    var filePath = HostingEnvironment.MapPath(ConfigurationManager.AppSettings["UserIconsFolder"]) + fnm;
